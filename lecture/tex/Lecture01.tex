...
\begin{frame}
	...
	\begin{block}{Pre-exam homework assignment}
		\begin{itemize}
			\item Will be made available via moodle or GitHub at end of the lecture series.
			\item Practical RL programming task, i.e., solve a typical RL problem.
			\item Further regulations:
			      \begin{itemize}
				      \item Submit your final programming solution at least two days before the exam.
