...
\frame{\frametitle{Additional topics not covered in this lecture (2)}
	\begin{itemize}
		...
		\item<2-> \hl{Federated learning}: finding solutions to distributed problems via multiple independent sessions, each using its own local information (addressing critical issues such as data privacy, data security, data access rights).
		      \begin{itemize}
			      \item<2-> \href{https://arxiv.org/abs/1901.08277}{H. Zhuo et al. "Federated Deep Reinforcement Learning", arXiv:1901.08277, 2019}
			      \item<2-> \href{https://arxiv.org/abs/2108.11887}{J. Qi et al. "Federated Reinforcement Learning: Techniques, Applications, and Open Challenges", arXiv:2108.11887, 2021}
		      \end{itemize}
	\end{itemize}
}
...
\frame{\frametitle{Learning summary}
	...
	\begin{block}{Concluding remarks}
		\begin{itemize}
			...
			\item Some aspects, especially within the exercises, had a control focus. In other application (e.g., training on visual data), specific RL solutions can look quite different.  \pause
